...
const std::string
CorbaClient::DEFAULT_OMNIORB_NAMESERVICE_HOST = "localhost";
...
CORBA::Object_ptr 
CorbaClient::connectToServant(const std::string& m_HostNameServer,
			      int nameServicePort)
{
  ...
  name.length (2);
  name[0].id   = "RobotViewer";
  name[0].kind = "context";
  name[1].id   = "RobotViewer";
  name[1].kind = "object";
